...
for n in 1 2 4 8 16 20; do
  ...
  echo $n>> /home/samadio/hpc/Parallel_progr/Day2/ex1/crit10.txt
  #5 iterations for each number of threads
  for tries in 1; do
   	/home/samadio/hpc/Parallel_progr/Day2/ex1/crit >>/home/samadio/hpc/Parallel_progr/Day2/ex1/crit10.txt
  done
