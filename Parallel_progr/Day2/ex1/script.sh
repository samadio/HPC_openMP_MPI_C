...
for n in 1 2 4 8 16 20; do
  ...
  echo ${n}>> /home/samadio/hpc/Parallel_progr/Day2/ex1/parallel_crit.txt
  #5 iterations for each number of threads
  for tries in 1 2 3 4 5; do
   	/home/samadio/hpc/Parallel_progr/Day2/ex1/parallel >>/home/samadio/hpc/Parallel_progr/Day2/ex1/parallel_crit.txt
   done
